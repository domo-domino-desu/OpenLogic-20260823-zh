...
Cantor 引入了这个“$\aleph$”记号；这是 \emph{aleph}，希伯来字母表的第一个字母，也是希伯来语中“无穷”一词的首字母。Peirce引入了“$\beth$”记号；这是 \emph{beth}，希伯来字母表的第二个字母。\footnote{Peirce 在 1900 年 12 月写给 Cantor 的信中使用了这个记号。不幸的是，Peirce 在那里还给出了一个错误的论证，声称对于 $\alpha \geq \omega$，$\beth_\alpha$ 不存在。}由此，这些记号便为我们给出了无穷基数。
