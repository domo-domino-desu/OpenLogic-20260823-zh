...
在 \olref[sth][z][milestone]{sec} 中，我们曾建议你回顾 \olref[sfr][][]{part} 中的朴素集合论工作，并检查它能否在~$\Zminus$ 中开展。如果你遵循了那条建议，\emph{有一处}可能会让你遇到麻烦：那就是 Dedekind（戴德金）处理\emph{闭包}时对\emph{交集}的使用。
