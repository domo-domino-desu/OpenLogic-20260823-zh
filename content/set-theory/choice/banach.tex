...
\olsection{Banach--Tarski 悖论}

正如 Boolos尝试为替换公理辩护一样，我们或许也可以尝试诉诸\emph{外在理由}来为选择公理辩护（参见 \olref[replacement][extrinsic]{sec}）。毕竟，采用选择公理有许多理想的推论：能够比较每个基数；能够良序化每个集合；能够将基数视为特定种类的序数；等等。
