...
\olsection{\texorpdfstring{将各个阶段定义为 $V_\alpha$}{将各个阶段定义为 V-alpha}}

在 \olref[sth][ordinals][]{chap} 中，我们定义了良序与 von Neumann序数。在本章中，我们将用它们来刻画集合层级\emph{本身}。为此，回顾在 \olref[sth][ordinals][opps]{sec} 中，我们定义了后继序数与极限序数的概念。我们在以下定义中使用这些概念：
