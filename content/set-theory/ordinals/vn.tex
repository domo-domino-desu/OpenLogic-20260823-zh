...
\olsection[Von Neumann's Construction]{von Neumann的序数构造}
...
\]
你会注意到，这些正是我们在无穷公理中，即在 冯·诺伊曼 对 $\omega$ 的定义中（参见 \olref[sth][z][infinity-again]{sec}）最初遇到的那几个序数。
这并非巧合。冯·诺伊曼 的序数定义将自然数视为序数，但也允许存在超限序数。

和往常一样，我们现在可以问：这些\emph{就是}序数吗？还是说 冯·诺伊曼 仅仅给了我们一些可以\emph{当作}序数来处理的集合？
