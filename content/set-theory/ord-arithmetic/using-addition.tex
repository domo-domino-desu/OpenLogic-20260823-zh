...
\begin{enumerate}
	...
	\item\ollabel{ord:infinite} $\alpha$ 是 戴德金无穷的
	\end{enumerate}
\end{lem}
...
(\alpha \disjointsum 1) \to \alpha$。对每个 $\gamma < \alpha$ 定义 $g(\gamma) = f(\gamma, 0)$；该单射见证了 $\alpha$ 是 戴德金 无穷的，因为 $f(0,1) \in \alpha \setminus \ran{g}$。
