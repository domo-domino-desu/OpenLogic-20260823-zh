...
\begin{proof}
对任意基数 $\cardfont{a}$，Cantor 定理 (\olref[sfr][siz][car]{thm:cantor}) 与 \olref[cardinals][cardsasords]{lem:CardinalsExist} 蕴涵了 $\cardfont{a} < \card{\Pow{\cardfont{a}}}$。
\end{proof}
...
应将此结论与 Russell悖论及 Burali-Forti（Burali-Forti）悖论进行比较。
