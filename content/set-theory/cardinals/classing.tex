...
\begin{enumerate}
	...
	\item\ollabel{card:infinite} $A$ 是 戴德金 无限的。
\end{enumerate}
\end{thm}
...
事实上，没有良序定理，就可能存在既非有限亦非 戴德金 无限的集合。
...
\begin{proof}
$\omega$ 是基数，因为 $\omega$ 是 戴德金 无限的，且若对任意 $n \in \omega$ 有 $\cardeq{\omega}{n}$，
则 $n$ 将是 戴德金 无限的，
...
\begin{proof}
对任意基数 $\cardfont{a}$，康托尔定理 (\olref[sfr][siz][car]{thm:cantor}) 与 \olref[cardinals][cardsasords]{lem:CardinalsExist} 蕴涵了 $\cardfont{a} < \card{\Pow{\cardfont{a}}}$。
\end{proof}
...
应将此结论与 罗素悖论及 Burali-Forti（布拉利-福尔蒂）悖论进行比较。
