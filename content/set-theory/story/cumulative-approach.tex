...
\]
现在，证明 罗素悖论时所涉及的推理将表明，$R_S$ 本身在阶段 $S$ 之前是不可用的。而这并不矛盾。此外，如果我们接受累积迭代的集合概念，那么我们甚至不应该\emph{期望}能够形成 罗素 集本身。因为那将是所有“终将可用”的非自属集合的集合。简而言之：在累积迭代的故事看来，我们（可证地）不能形成 罗素 集这一事实并不\emph{令人意外}；这正是我们所\emph{预测}的。
