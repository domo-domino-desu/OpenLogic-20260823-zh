...
\olsection{附录：弗雷格的基本定律 V}

在 \olref[rus]{sec} 中，我们解释了 Russell（罗素）如何将其悖论表述为 Frege（弗雷格）在其 \emph{Grundgesetze} 中所概述的系统的问题。弗雷格的系统并未直接包含素朴概括原理的表述。因此，在本附录中，我们将非常简要地解释弗雷格的系统究竟\emph{包含}了什么，以及它与素朴概括原理和罗素悖论分别有何关系。
