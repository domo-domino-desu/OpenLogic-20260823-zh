...
简单类型化λ演算中的项与自然演绎推导之间的这种对应关系，被称为“柯里--Howard”对应、“证明即程序”或“命题即类型”对应。除了公式（命题）对应于类型、证明对应于项之外，我们可以将对应关系总结如下：
...
柯里--Howard 对应是自动证明助理和程序类型检查器的基石之一，因为检查一个见证命题的证明（正如我们上面所做的那样），就相当于检查一个程序（项）是否具有所声明的类型。
\end{document}