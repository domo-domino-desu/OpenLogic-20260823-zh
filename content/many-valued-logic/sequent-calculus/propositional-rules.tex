...
以下 $\lnot$ 的规则适用于 Łukasiewicz（乌卡谢维奇）逻辑、克林逻辑及其变体。
...
（在 哥德尔 逻辑中，$\lnot !A$ 永远不会取 $\Undef$ 值，因此不存在针对中间位置的规则。）

\subsection{$\land$ 的规则}

以下是 Łukasiewicz 逻辑、强 克林 逻辑和 哥德尔 逻辑中 $\land$ 的规则。
...
以下是 Łukasiewicz 逻辑、强 克林 逻辑和 哥德尔 逻辑中 $\lor$ 的规则。
