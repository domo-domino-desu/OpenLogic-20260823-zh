...
\begin{explain}
这个定理与 G\"odel 在 1931 年对第一不完全性定理的原始表述相去不远。除了更现代的术语，关键区别在于：G\"odel 使用的是“$\omega$-一致的”而非“一致的”；并且他无法完全一般性地谈论“可公理化”，因为当时可计算性的形式概念尚未建立。（可计算性的形式模型是在接下来的十年中发展起来的，其中包括 G\"odel 的工作，很大程度上正是为了刻画易受 G\"odel 现象影响的理论。）
