...
\olsection{$\Th{Q}$ 是 \printtoken{S}{c.e.}-完全的}
...
它是一个完全的 c.e. 集，等价于 $K \leq_m Q$，其中 $K = \Setabs{x}{!A_x(x) \downarrow}$。下面证明 $K$ 可归约到 $\Th{Q}$。由于 克林 谓词 $T(e,x,s)$ 是原始递归的，它在 $\Th{Q}$ 中是可表示的，设由 $!A_T$ 表示。那么对任意 $x$，我们有
\begin{align*}
