...
\begin{defn}
由下列语句公理化而成的理论 $\Th{Q}$ 被称为“鲁滨逊 的 $\Th{Q}$”，它是一个非常简单的算术理论。
\begin{align*}
...
\emph{皮亚诺 算术}~$\Th{PA}$ 是由 $\Th{Q}$ 的公理连同所有归纳模式的实例公理化而成的理论。
\end{defn}
