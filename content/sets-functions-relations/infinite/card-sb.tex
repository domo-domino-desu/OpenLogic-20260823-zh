...
在本章中，我们遵循了 戴德金的\emph{闭包}概念。事实上，戴德金 利用这个概念给出了 Schr\"oder-Bernstein 定理的一个优美证明，我们将在此介绍。该证明紧随 \citet[pp.~157--8]{Potter2004} 的论述；若你想要略有不同但本质相似的处理，可以参考该书。稍作搜索你也会发现，这个定理——很像 $\sqrt{2}$ 的无理性——有许多有趣且不同的证明。
