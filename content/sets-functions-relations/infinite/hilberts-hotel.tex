...
自然数集显然是无穷的。所以，如果我们不想\emph{直接诉诸}自然数，那么第一步就必须用不涉及自然数本身的术语来刻画无穷集合。这里有一个很好的方法，由 Hilbert 在 1924 年的一次讲座中提出。他让我们想象
...
关键点在于，希尔伯特旅馆拥有无穷多个房间；我们可以把他的解释用来定义“拥有无穷多”意味着什么。事实上，这正是 Dedekind 的进路（当然，这里的呈现有着严重的时代错位；Dedekind 的定义来自 \citeyear{Dedekind1888}）：
