...
关键点在于，希尔伯特旅馆拥有无穷多个房间；我们可以把他的解释用来定义“拥有无穷多”意味着什么。事实上，这正是 戴德金 的进路（当然，这里的呈现有着严重的时代错位；戴德金 的定义来自 \citeyear{Dedekind1888}）：

\begin{defn}\ollabel{defn:DedekindInfinite}
集合 $A$ 是 \emph{戴德金 无穷的}，当且仅当存在一个从~$A$ 到其真子集的单射。
