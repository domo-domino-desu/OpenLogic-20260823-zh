...
首先，从分割的角度来理解实数，是否比用其熟悉的（可能无限的）十进制展开来理解实数\emph{更}严格，这一点并不清楚。后一种对实数的“构造”有些类似于通过Cauchy（柯西）序列构造实数；但事实上，从17世纪早期起，数学家们实质上就已经知道了这种构造（参见 \olref[cauchy]{sec}）。严格性的真正提升在于认识到实数具有完备性质；而将实数构造为特定集合的能力本身，也许并不那么有趣。
