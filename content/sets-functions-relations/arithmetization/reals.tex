...
实数的表现与有理数非常相似。（从技术上讲，两者都是\emph{有序域}的例子；关于其定义，参见\olref[check]{orderedfield}。）如果完成了\olref[sfr][siz][]{chap}的练习，就会知道实数严格多于有理数，即$\cardless{\Rat}{\Real}$。这是Cantor 首先证明的。但人们知道存在无理数（即非有理数的实数）已有两千五百多年了。事实上：
