...
逻辑学中称为\emph{可计算性理论}的分支，研究函数与集合的可计算性或相对可计算性问题。由于 Kleene（克林）的影响，该学科曾被称为\emph{递归理论}，如今这两个名称都常被使用。% Part: computability
...
\item \emph{非形式地}：描述一个计算它的算法，并诉诸 Church（邱奇）论题。
\end{enumerate}
