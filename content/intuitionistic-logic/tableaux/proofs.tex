...
如 \olref{int}{tab}{mon} 中所述，直觉主义 Kripke 模型中的满足关系是单调的：如果 $\mathfrak{M}, \Gamma \models !A$ 且 $\Gamma R \Delta$，则 $\mathfrak{M}, \Delta \models !A$。我们现在通过对~$!A$ 的结构归纳来证明这一点。
